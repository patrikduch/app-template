...
var CurrencyWhere = struct {
	...
	CurrencyName: whereHelperstring{field: "\"currency\".\"currency_name\""},
}
...
var (
	currencyAllColumns            = []string{"id", "currency_name"}
	currencyColumnsWithoutDefault = []string{"currency_name"}
